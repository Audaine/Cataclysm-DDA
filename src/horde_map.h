...
class horde_map
{
        std::unordered_map <tripoint_om_sm, std::unordered_map<tripoint_abs_ms, horde_entity>>
                active_monster_map;
    ...
    public:
        ...
        bool entity_at( const tripoint_om_ms &p );
        ...
        class iterator
        {
                ...
                std::unordered_map <tripoint_om_sm, std::unordered_map<tripoint_abs_ms, horde_entity>> *outer_map =
                            nullptr;
        ...
        // TODO: Do I need to expose a copy constructor?
